...
export const SHOP_PRICES: PriceItem[] = [
  ...
  { name: 'Cut & Shave + Black Dye (with Wash)', price: 150 },
  { name: 'Black Fiber (add-on)', price: 130 },
  { name: 'Cut & Dye + Hot Towel/Steam', price: 200 },
...
export const HOUSE_PRICES: PriceItem[] = [
  { name: 'Cut & Shave (House Call)', price: 250 },
  { name: "Kids' Cut (House Call)", price: 150 },
  { name: 'Cut & Dye Application (House Call)', price: 300 },
];
